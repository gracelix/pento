defmodule PentoWeb.Admin.DashboardLive do
  ...
  alias PentoWeb.Admin.{SurveyResultsLive, UserActivityLive, UserSurveyCountLive}
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok,
     ...
     |> assign(:user_survey_component_id, "user_survey_count")}
  end
  ...
  def handle_info(%{event: "presence_diff"}, socket) do
    ...
    send_update(UserSurveyCountLive, id: socket.assigns.user_survey_component_id)
    {:noreply, socket}
  end
end
